...
#import "WeiuiSidePanelComponent.h"
#import "WeiuiSidePanelItemComponent.h"
#import "UIImage+TBCityIconFont.h"
#import "DeviceUtil.h"

#define SideItemComponentTag 800

@interface WeiuiSidePanelComponent()
...
@implementation WeiuiSidePanelComponent
...
- (void)loadComponentView
{
    ...
    for (int i = 0; i< _subViews.count; i++) {
        WeiuiSidePanelItemComponent *component = _subViews[i];
...
- (void)insertSubview:(WXComponent *)subcomponent atIndex:(NSInteger)index
{
    ...
    if ([subcomponent isKindOfClass:[WeiuiSidePanelItemComponent class]]) {
...
- (void)itemPanClick:(UITapGestureRecognizer*)panRecognizer
{
    ...
    if (index < _subViews.count) {
        WeiuiSidePanelItemComponent *cmp = _subViews[index];
...
- (void)showPanelView
{
    __weak typeof(WeiuiSidePanelComponent) *ws = self;
